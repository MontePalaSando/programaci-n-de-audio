...
from ProgramaNiveles import Audio
        ...
        while Bucle ==1:
            ...
            if opcion == 5:
                ...
                if opcion == 1:
                    print("Senosoidal")
                    #Crear la instancia de la clase audio para generar los datos
                    onda = Seno(Tono, Frecuenciadesampleo, MaxBits, Tiempo,NivelPi)
                    #Generar el arreglo
                    datos = onda.generar()
                    #Graficar Archivo
                ...
                if opcion == 2:
                    print("Cuadrada")
                    #Crear la instancia de la clase audio para generar los datos
                    onda = cuadro(Tono, Frecuenciadesampleo, MaxBits, Tiempo, NivelPi)
                    #Generar el arreglo
                    datos = onda.generar()
                    #Graficar Archivo
                    archivo = Archivo(Frecuenciadesampleo, MaxBits, Nombre)
                ...
                if opcion == 3:
                    print("Triangular")
                    #Crear la instancia de la clase audio para generar los datos
                    onda = triangulo(Tono, Frecuenciadesampleo, MaxBits, Tiempo,NivelPi)
                    #Generar el arreglo
                    datos = onda.generar()
                    #Graficar Archivo
                    archivo = Archivo(Frecuenciadesampleo, MaxBits, Nombre)
                ...
                if opcion == 4:
                    print("Diente Sierra")
                    #Crear la instancia de la clase audio para generar los datos
                    onda = sierra(Tono, Frecuenciadesampleo, MaxBits, Tiempo,NivelPi)
                    #Generar el arreglo
                    datos = onda.generar()
                    #Graficar Archivo
                    archivo = Archivo(Frecuenciadesampleo, MaxBits, Nombre)
