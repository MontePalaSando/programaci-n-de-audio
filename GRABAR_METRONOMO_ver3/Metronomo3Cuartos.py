...
class Metro34:
     ...
     def metrono2(self):
            ...
            if opcion2 == 1: # DO
                Tono = [Do2,Silencio,Do,Silencio,Do,Silencio]
                Tiempo =[Cor,Cor,Cor,Cor,Cor,Cor]

            if opcion2 == 2: # DO SOSTENIDO
                Tono = [Doso2,Silencio,Doso,Silencio,Doso,Silencio]
                Tiempo =[Cor,Cor,Cor,Cor,Cor,Cor]

            if opcion2 == 3: # RE
                Tono = [Re2,Silencio,Re,Silencio,Re,Silencio]
                Tiempo =[Cor,Cor,Cor,Cor,Cor,Cor]

            if opcion2 == 4: # RE SOSTENIDO
                Tono = [Reso2,Silencio, Reso,Silencio, Reso,Silencio]
                Tiempo =[Cor,Cor,Cor,Cor,Cor,Cor]

            if opcion2 == 5: # MI
                Tono = [Mi2,Silencio,Mi,Silencio,Mi,Silencio]
                Tiempo =[Cor,Cor,Cor,Cor,Cor,Cor]

            if opcion2 == 6: # FA
                Tono = [Fa2,Silencio,Fa,Silencio,Fa,Silencio]
                Tiempo =[Cor,Cor,Cor,Cor,Cor,Cor]

            if opcion2 == 7: # FA SOSTENIDO
                Tono = [Faso2,Silencio,Faso,Silencio,Faso,Silencio]
                Tiempo =[Cor,Cor,Cor,Cor,Cor,Cor]

            if opcion2 == 8: # SOL
                Tono = [Sol2,Silencio,Sol,Silencio,Sol,Silencio]
                Tiempo =[Cor,Cor,Cor,Cor,Cor,Cor]

            if opcion2 == 9: # SOL SOSTENIDO
                Tono = [Solso2,Silencio,Solso,Silencio,Solso,Silencio]
                Tiempo =[Cor,Cor,Cor,Cor,Cor,Cor]

            if opcion2 == 10: # LA
                Tono = [La2,Silencio,La,Silencio,La,Silencio]
                Tiempo =[Cor,Cor,Cor,Cor,Cor,Cor]

            if opcion2 == 11: # LA SOSTENIDO
                Tono = [Laso2,Silencio,Laso,Silencio,Laso,Silencio]
                Tiempo =[Cor,Cor,Cor,Cor,Cor,Cor]

            if opcion2 == 12: # SI
                Tono = [Si2,Silencio,Si,Silencio,Si,Silencio]
                Tiempo =[Cor,Cor,Cor,Cor,Cor,Cor]
