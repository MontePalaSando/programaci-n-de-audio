...
public class AudioGenerator {
    ...
    public void AudioGenerator(int duracion, int frecuencia) throws IOException {
    ...
    public void AudioGenerator2(int duracion, int frecuencia) throws IOException {
        int numSamples = duracion * sRate;
        try {
            randomAccessWriter.writeInt(Integer.reverseBytes(numSamples));
        } catch (IOException e) {
    ...
    public void AudioGenerator3(int duracion, int frecuencia) throws IOException {
        int numSamples = duracion * sRate;
        try {
            randomAccessWriter.writeInt(Integer.reverseBytes(numSamples));
        } catch (IOException e) {
    ...
    public void AudioGenerator4(int duracion, int frecuencia) throws IOException {
        int numSamples = duracion * sRate;
        try {
            randomAccessWriter.writeInt(Integer.reverseBytes(numSamples));
        } catch (IOException e) {
